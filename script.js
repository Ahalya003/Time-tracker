document.addEventListener('DOMContentLoaded', function () {
  ...
  function startTimer() {
      startButton.style.setProperty('background-color','#60c837');
  ...
  function stopTimer() {
      startButton.style.setProperty('background-color','white');
      stopButton.style.setProperty('background-color','#a70019');
      clearInterval(timerInterval);
  }
  ...
  function handleEnter() {
      ...
      if (timerInterval) {
          stopTimer();
          stopButton.style.setProperty('background-color','white');
